...
export default function CheckoutPage() {
  ...
  const { selectedAddressId, couponCode, discountAmount } = useAppSelector(
  ...
  useEffect(() => {
    ...
    const fetchAddresses = async () => {
      try {
        ...
        if (
          newAddressId &&
          fetchedAddresses.find((a) => a.id === newAddressId)
        ) {
          ...
          !selectedAddressId ||
          !fetchedAddresses.find((a) => a.id === selectedAddressId)
        ) {
          // Auto-select logic
          const defaultAddr =
      ...
      <div className="flex flex-col gap-6 max-w-3xl mx-auto">
        ...
        <div className="lg:col-span-1">
          <Card className="p-6 sticky top-8">
            <Heading size="4" className="font-semibold mb-6">
              Order Summary
            </Heading>
            ...
            <Button
              ...
              disabled={
                deployingOrder || isSelectingAddress || !selectedAddressId
              }
            >
